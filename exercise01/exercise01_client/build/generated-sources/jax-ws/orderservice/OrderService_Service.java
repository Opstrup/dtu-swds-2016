 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://OrderService/", wsdlLocation = "http://localhost:8080/exercise01_service/OrderService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/exercise01_service/OrderService?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://OrderService/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://OrderService/", "OrderServicePort"), OrderService.class, features);
    }
